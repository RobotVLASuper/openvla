...
def make_oxe_dataset_kwargs(
    ...
    if dataset_kwargs["action_encoding"] not in [ActionEncoding.EEF_POS, ActionEncoding.EEF_R6, ActionEncoding.JOINT_POS_BIMANUAL,ActionEncoding.JOINT_POS_ABS]:
    ...
    #NOET: 夹爪不做归一化，其他做
    elif dataset_kwargs["action_encoding"] is ActionEncoding.JOINT_POS_ABS:
